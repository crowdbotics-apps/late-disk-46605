"""
Django settings for late_disk_46605 project.
...
ROOT_URLCONF = 'late_disk_46605.urls'
...
WSGI_APPLICATION = 'late_disk_46605.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_disk_46605 API",
    "DESCRIPTION": "API documentation for late_disk_46605 App",
    "VERSION": "v1",
}
